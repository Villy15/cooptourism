...
// Add image to storage
  Future<String> addImageToStorage(String? uid, XFile imageFile) async {
    ...
    String fullPath = 'events/$uid/$fileName';
    ...
    List<Map<String, dynamic>> events = [
      {
        ...
        'description':
            'Join us for a 3-day adventure in the heart of Palawan. Explore the hidden lagoons, snorkel in crystal-clear waters, and enjoy the tranquility of this paradise.',
      ...
      },
      {
        ...
        'endDate':
            DateTime.now().add(const Duration(days: 7)).millisecondsSinceEpoch,
        'description':
            'Take a step back in time and discover the rich history of the Philippines with our guided walk in Intramuros, the Walled City of Manila.',
      ...
      },
      {
        ...
        'description':
            'Challenge yourself with a trek to the highest peak in the Philippines. Witness diverse flora and fauna, enjoy the scenic views, and immerse yourself in the beauty of nature.',
        'participants': ['John Doe', 'Jane Doe', 'John Smith', 'Jane Smith'],
  ...
  Future<List<String>> getEventImageUrls(
    ...
    for (String imagePath in imagePaths) {
      String fullPath = 'events/$uid/$imagePath';
