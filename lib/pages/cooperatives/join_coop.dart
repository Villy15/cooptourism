  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView (
        child:
            StreamBuilder(
              stream: cooperativeRepository.getCooperative(widget.coopId).asStream(),
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(child: DisplayImage(path: '${widget.coopId}/images/${coop!.logo}', height: 120, width: 120, radius: BorderRadius.circular(100))),
                        const SizedBox(height: 15),
                        Center(
                          child: Text(
                            coop.name!,
          ...
          style: TextStyle(
            ...
            fontSize: 17,
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            String extension = path.extension(uploadedFiles[index].path).toLowerCase();
                            IconData iconData;
                            ...
                            return ListTile(
                              ...
                              title: Text(path.basename(uploadedFiles[index].path)),
                            );
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed: () async {
                              if(uploadedFiles.isEmpty || _reasonController.text.isEmpty) {
                              ...
                              final coopApplication = CooperativeAppFormModel(
                                ...
                                await joinCooperativeRepository.addCoopApplication(coopApplication);
                                for (final file in uploadedFiles) {
                                  final fileName = path.basename(file.path);
                                  final destination = '${widget.coopId}/appforms/${user.uid}/documents/$fileName';
