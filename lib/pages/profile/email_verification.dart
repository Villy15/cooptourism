...
class EmailVerificationPage extends ConsumerStatefulWidget {
  ...
  const EmailVerificationPage({Key? key, required this.profileId})
      : super(key: key);
          ...
          Center(
            child: Container(
                ...
                child: Icon(Icons.mark_email_read,
                    size: 70, color: Theme.of(context).colorScheme.secondary)),
          ),
                      ...
                      if (_emailController.text == user!.email) {
                        ...
                        if (await emailAuth.sendOTP() == true) {
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text('Email OTP has been sent!')));
                        }
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                    ...
                    onPressed: () async {
                      if (await emailAuth.verifyOTP(otp: _otpController.text)) {
                        ...
                        GoRouter.of(context).go(
                            '/profile_page/${widget.profileId}/edit_profile');
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
